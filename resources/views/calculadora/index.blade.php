...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="container w-full">
                ...
                <span class="titulo">COMPARATIVO DE PAGO DE INTERESES DE COAST TO COAST CON OTROS DISTRIBUIDORES</span>
            </br></br>
            <table>
            <tr>
            ...
            <div id='results' style="display: none">
                <table>
                    <tr>
                        ...
                        <tr>
                            <td>
                                <input id="month_others" type="text" disabled>
                            </td>
                            <td>
                                <input id="month_ctc" type="text" disabled>
                            </td>
                            <td>
                                <input id="total_others" type="text" disabled>
                            </td>

                        <td>
                            <input id="total_ctc" type="text" disabled>
                        </td>
                        </tr>
                    </tr>
                </table>
