<div class="h-96 w-96 border-2 border-collapse border-gray-500" style="border: 2px solid #000;">
    <label class="inline px-2 m-2 text-gray-700 text-lg font-pop font-semibold mb-4">{{__("0% Interest Program")}}</label>
    ...
    <div class="flex rounded-lg justify-between">
        ...
        <label> {{ number_format($ctc_downpayment, 2, '.', ',')}} </label>
    </div>
    ...
    <div class="flex text-white rounded justify-between mt-4">
        ...
        <label class="inline px-2 m-2 text-white bg-green-600 rounded text-lg font-bold text-left">$ {{number_format($ctc_amount_total- $others_amount_total)}}:</label>
    </div>
</div>
